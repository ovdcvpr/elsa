...
dct = dict(model.named_parameters())
for key, value in dct.items():
    print(key, value.shape)


# from mdetr.models.mdetr import MDETR
# obj = object.__new__(MDETR)
# obj.__dict__.update(model.__dict__)
# model = obj

type(model)
# model.__call__.__func__

url = "http://images.cocodataset.org/val2017/000000281759.jpg"
im = Image.open(requests.get(url, stream=True).raw)
# caption = '5 people each holding an umbrella'
caption = 'a gathering standing'
...
def plot_inference(im, caption):
    ...
    # keep only scored with 0.7+ confidence
...
# plot_inference(im, "a gathering standing")

im = Image.open('/home/redacted/Downloads/images/103332101110110302_x4_cropped.png')
plot_inference(im, "a gathering standing")
